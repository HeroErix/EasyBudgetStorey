...
public class DatePicker extends JTextField {
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        Dialog owner = (Dialog) SwingUtilities.getWindowAncestor(DatePicker.this);
    ...
    private JDialog createDateDialog(Dialog owner, JPanel contentPanel) {
    ...
    private Point getAppropriateLocation(Dialog owner, Point position) {
